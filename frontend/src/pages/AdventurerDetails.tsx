                ...
                <>
                    ...
                    <div className="adventurer-detail__stats">
                        <div className="adventurer-detail__stat">
                            ...
                            <Reward gold={adventurer.gold} large />
                        </div>
                    ...
                    <section className="adventurer-detail__section">
                        ...
                        {onGoing === null ? (
                            ...
                            <div className="card quest-line">
                                ...
                                <DifficultyBadge difficulty={onGoing.questDifficulty} />

                                <Reward gold={onGoing.goldReward} xp={onGoing.xpReward} />
                                        ...
                                        <tbody>
                                            {completed.map((assignment) => (
                                                <tr key={assignment.id}>
                                                    ...
                                                    <td>
                                                        <DifficultyBadge
                                                            difficulty={assignment.questDifficulty}
                                                        />
                                                    </td>
                                                    <td>
                                                        <Reward
                    ...
                    {completeOpen && onGoing !== null && (
                        <CompleteQuestModal
                            ...
                            assignment={{ adventurer, assignment: onGoing }}
